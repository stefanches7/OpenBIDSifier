...
"""
        # Fake "extra info" message
        if "1.3" in step:
            response = "Please, fill extra information about blah blah."

    # Check if the LLM needs extra information
    if "extra information" in response.lower():
        gr.Warning("Please, fill the extra information!")
